...
Inline SVG sun, dot, and dune accents are decorative, non-focusable, and clipped.
...
<head>
    ...
    <style>
        ...
        *,*::before,*::after {box-sizing:border-box}
        ...
        .hero {width:min(1600px,calc(100% - 36px));margin:0 auto;position:relative;isolation:isolate;overflow:hidden;border-radius:20px;background:#6b513a;color:#fff}
        ...
        .hero-caption {position:absolute;bottom:71px;right:max(35px,calc((100% - 1240px)/2));display:flex;align-items:center;gap:8px;font-size:9px;letter-spacing:.5px;color:#f4e5d3}
        ...
        @media(max-width:1150px) {
            .container{width:calc(100% - 64px)}.nav-links{gap:20px}.nav-actions .button{padding-inline:14px}
        ...
        @media(max-width:700px) {
            :root{--header-height:73px}html{scroll-padding-top:90px}.container{width:calc(100% - 40px)}.section{padding-block:65px}
            ...
            .hero{width:calc(100% - 20px);border-radius:15px}.hero-inner{display:block;padding:66px 6px 94px;min-height:595px;width:calc(100% - 36px)}.hero h1{font-size:clamp(51px,9.3vw,67px);letter-spacing:-1.8px;max-width:540px}
            ...
            .hero-side{display:none}.hero-caption{bottom:57px;right:25px;font-size:8px}.hero-caption .icon{width:11px;height:11px}.finder-wrap{margin-top:-27px;width:calc(100% - 40px)}
        ...
        .ambient-decor {position:absolute;inset:0;z-index:-1;overflow:hidden;pointer-events:none;user-select:none;-webkit-user-select:none}
        ...
        .decor-mark--dots {width:82px;height:62px;color:var(--decor-olive);opacity:.30}
        .decor-mark--dunes {width:170px;height:77px;opacity:.22}
        .ambient-decor--about .decor-mark--sun {right:-30px;top:44px;width:150px;height:150px}
        .ambient-decor--about .decor-mark--dots {left:18px;bottom:46px}
        .ambient-decor--collection .decor-mark--sun {right:3%;top:32px;width:92px;height:92px;opacity:.20}
        .ambient-decor--collection .decor-mark--dots {left:14px;top:47%;width:55px}
        .ambient-decor--collection .decor-mark--dunes {right:24px;bottom:12px}
        .ambient-decor--signature .decor-mark--dots {left:16px;top:30px}
        .ambient-decor--signature .decor-mark--sun {right:-29px;bottom:10px;width:105px;height:105px}
        .ambient-decor--steps .decor-mark--sun {left:2%;top:5px;width:80px;height:80px}
        .ambient-decor--steps .decor-mark--dots {right:3%;bottom:20px;width:67px}
        .ambient-decor--gallery .decor-mark--sun {right:15%;top:18px;width:82px;height:82px;opacity:.22}
        .ambient-decor--gallery .decor-mark--dunes {left:8px;bottom:7px}
        .ambient-decor--stories .decor-mark--sun {left:3%;top:38px;width:97px;height:97px}
        .ambient-decor--stories .decor-mark--dots {right:18px;bottom:38px}
        .ambient-decor--faq .decor-mark--dunes {left:12px;bottom:12px;width:130px}
        .ambient-decor--faq .decor-mark--dots {right:13px;top:17px;width:60px;opacity:.23}
        .ambient-decor--contact .decor-mark--sun {left:-35px;top:27px;width:130px;height:130px}
        .ambient-decor--contact .decor-mark--dots {right:16px;bottom:20px;width:78px}
        .ambient-decor--closing,.ambient-decor--footer {--decor-ink:#f2d3a4;--decor-olive:#e9d2ac;--decor-opacity:.28}
        .ambient-decor--closing .decor-mark--sun {left:12%;top:26px;width:85px;height:85px}
        .ambient-decor--closing .decor-mark--dots {right:12%;bottom:33px;width:75px;opacity:.26}
        .ambient-decor--footer .decor-mark--sun {right:-30px;top:26px;width:155px;height:155px;opacity:.17}
        .ambient-decor--footer .decor-mark--dots {left:12px;bottom:26px;width:65px;opacity:.15}
        ...
        @media(max-width:700px) {
            ...
            .decor-mark{--decor-opacity:.22}
            .ambient-decor--about .decor-mark--sun{width:98px;height:98px;right:-33px;top:12px}
            .ambient-decor--about .decor-mark--dots{width:55px;left:5px;bottom:13px}
            .ambient-decor--collection .decor-mark--sun{width:65px;height:65px;right:-21px;top:18px}
            .ambient-decor--collection .decor-mark--dots{width:35px;left:-12px}
            .decor-mark--dunes{width:108px;height:50px}
            .ambient-decor--signature .decor-mark--dots{width:53px;left:4px;top:8px}
            .ambient-decor--signature .decor-mark--sun{width:75px;height:75px;right:-25px;bottom:0}
            .ambient-decor--steps .decor-mark--sun{width:62px;height:62px;left:-22px;top:0}
            .ambient-decor--steps .decor-mark--dots{width:50px;right:1%;bottom:15px}
            .ambient-decor--gallery .decor-mark--sun{right:-20px;width:72px;height:72px;top:12px}
            .ambient-decor--stories .decor-mark--sun{left:-29px;top:10px;width:85px;height:85px}
            .ambient-decor--stories .decor-mark--dots{right:4px;bottom:12px;width:54px}
            .ambient-decor--faq .decor-mark--dots{right:2px;width:49px}
            .ambient-decor--faq .decor-mark--dunes{left:-16px;width:94px;bottom:3px}
            .ambient-decor--contact .decor-mark--sun{left:-25px;top:18px;width:80px;height:80px}
            .ambient-decor--contact .decor-mark--dots{right:3px;bottom:4px;width:51px}
            .ambient-decor--closing .decor-mark--sun{left:-13px;top:17px;width:68px;height:68px}
            .ambient-decor--closing .decor-mark--dots{right:1%;bottom:9px;width:47px}
            .ambient-decor--footer .decor-mark--sun{right:-30px;top:14px;width:111px;height:111px}
            .ambient-decor--footer .decor-mark--dots{left:3px;bottom:7px;width:45px}
        }
        ...
        @media screen and (prefers-color-scheme:dark) {
            :root {
                ...
                --decor-ink:#ddb184; --decor-olive:#c4cfa9; --decor-opacity:.24;
...
<main id="main">
    ...
    <section class="decorated-section section" id="about" aria-labelledby="about-title">
        <div class="ambient-decor ambient-decor--about" aria-hidden="true">
            <svg class="decor-mark decor-mark--sun" viewBox="0 0 160 160" aria-hidden="true" focusable="false" data-decor-drift><use href="#decor-sun"></use></svg>
            <svg class="decor-mark decor-mark--dots" viewBox="0 0 93 63" aria-hidden="true" focusable="false"><use href="#decor-dots"></use></svg>
        </div>
    ...
    <section class="decorated-section section experiences" id="experiences" aria-labelledby="experiences-title">
        <div class="ambient-decor ambient-decor--collection" aria-hidden="true">
            <svg class="decor-mark decor-mark--sun" viewBox="0 0 160 160" aria-hidden="true" focusable="false" data-decor-drift><use href="#decor-sun"></use></svg>
            <svg class="decor-mark decor-mark--dots" viewBox="0 0 93 63" aria-hidden="true" focusable="false"><use href="#decor-dots"></use></svg>
            <svg class="decor-mark decor-mark--dunes" viewBox="0 0 200 90" aria-hidden="true" focusable="false"><use href="#decor-dunes"></use></svg>
        </div>
        <div class="container">
